...
class Onepress_Customize_Repeatable_Control extends WP_Customize_Control
{
	...
	public function __construct($manager, $id, $args = array())
	{
		...
		$this->default_empty_title =  isset($args['default_empty_title']) && $args['default_empty_title'] != '' ? $args['default_empty_title'] : esc_html__('Item');
	}
...
?>
	...
	?>
		...
		<div class="repeatable-actions">
			<span class="button-secondary add-new-repeat-item"><?php echo ($this->add_text) ? esc_html($this->add_text) : __('Add an item'); ?></span>
		</div>
	<?php
	}
			...
			<div class="widget">
				<div class="widget-top">
					...
					<div class="widget-title">
						<h4 class="live-title"><?php _e('Item'); ?></h4>
					</div>
				</div>
																																															...
																																															<# if ( !field.media || field.media=='' || field.media=='image' ) { #>
																																																...
																																																<# } #>
																																																	...
																																																	<div class="actions">
																																																		...
																																																		<button class="button upload-button" data-media="{{field.media}}" data-add-txt="<?php esc_attr_e('Add'); ?>" data-change-txt="<?php esc_attr_e('Change'); ?>" type="button">
																																																			<# if ( ! field.value.url ){ #> <?php _e('Add'); ?> <# } else { #> <?php _e('Change'); ?> <# } #>
																																																		</button>
																																																	...
																																																	<# } else if ( field.type=='textarea' || field.type=='editor' ) { #>
																																																		...
																																																		<# } else if ( field.type=='icon' ) { #>
																																																			<# var icon_class=field.value; if ( icon_class.indexOf( 'fa-' ) !=0 ) { icon_class='fa-' + field.value; } else { icon_class=icon_class.replace( 'fa ' , '' ); } icon_class=icon_class.replace( 'fa-fa' , '' ); #>
																																																				...
																																																				<a href="#" class="remove-icon"><?php esc_html_e('Remove'); ?></a>
																																																				<# } #>
